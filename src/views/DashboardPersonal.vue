    ...
    <section class="content-area">
      ...
      <div class="dashboard-layout">
        <aside class="profile-left">
          ...
          <h2>Recepcionista</h2>
          <p>
            Bienvenida. Desde este espacio puedes gestionar citas creadas en recepción
            y revisar las citas pendientes del sistema.
          </p>
        </aside>
        ...
        <section class="profile-right">
          <div class="right-header">
            ...
            <p>Organiza tu día de trabajo con herramientas directas para recepción.</p>
          </div>
