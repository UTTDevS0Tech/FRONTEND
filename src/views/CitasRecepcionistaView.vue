    ...
    <section class="citas-shell">
      <div class="citas-layout">
        <aside class="citas-sidebar">
          ...
          <p>
            Consulta los tickets del sistema, filtra por cliente y administra cada cita desde un solo lugar.
          </p>
        ...
        <section class="citas-content">
          ...
          <div class="page-header">
            ...
            <p>Busca por cliente, revisa detalles y actualiza el estado de cada ticket.</p>
          </div>
          ...
          <div v-else-if="citaStore.error" class="empty-state error-state">
...
.estado-badge.completada {
  background: rgba(218, 241, 224, 0.95);
  color: #3f7a4a;
}
